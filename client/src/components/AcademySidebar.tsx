import { Home, Users, BookOpen, GraduationCap, CreditCard, Calendar, Bell, MessageSquare, ListChecks, Smartphone } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Toss Front", url: "/toss-front", icon: Smartphone },
];
