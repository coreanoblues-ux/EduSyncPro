...
- **Railway**: Hosting (Nixpacks build, `railway.toml`). Deploys from GitHub — no Replit involved.
- **Docker**: `Dockerfile` lets the same build run on any container host. See [REPLIT_EXIT.md](REPLIT_EXIT.md).
