              ...
              <ul className="mt-1 list-disc space-y-0.5 pl-5">
                ...
                <li>
                  ...
                  */}
                  ...
                  {/*
                    원장 신고 (2026-08-29): "첫화면으로를 눌렀을 때 화면이 바뀌질 않아."
                    원인은 setIdle 이 아니라 우리 화면이 그 위를 덮고 있던 것이었다.
                    고친 내용을 원장이 읽을 수 있게 여기에도 적는다.
                  */}
                  <div className="mt-1 text-xs text-amber-800">
                    v0.3.11 에서는 이 버튼을 눌러도 화면이 안 바뀌었습니다. 버튼은 정상
                    동작했지만 플러그인 화면이 토스 첫화면 <b>위를 덮고 있었습니다</b>.{" "}
                    <b>v0.3.12</b> 부터는 덮개를 먼저 걷고 나갑니다. 그래도 안 나가지면 3초
                    뒤 <b>[토스 설정 열기]</b> 가 있는 안내 화면이 대신 뜹니다.
                  </div>
                </li>
                {/*
                  7055 정정 (2026-08-29).
                  PIN 7055 는 docs.tossplace.com 트러블슈팅 문서에 명시된 공식 값이다
                  ("설정 → 7055 → 하단 '토스 프론트 재시작'"). 내가 틀렸던 것은 그 앞의
                  터치 동작이고, Toss 개발자 문서는 설정 진입 동작을 문서화하지 않는다.
                  그래서 두 방식을 다 적고, 확인되지 않았다는 사실도 같이 적는다.
                  플러그인 코드 주석에는 중복해 적지 않는다 — 한쪽이 반드시 낡는다.
                */}
                <li>
                  <b>단말기 설정으로 들어가는 방법</b> (배경화면 변경·플러그인 재시작에
                  필요합니다)
                  <ul className="mt-1 list-disc space-y-0.5 pl-5">
                    <li>
                      화면을 <b>한 번 터치</b> → 우측 상단에 <b>톱니바퀴 아이콘</b>이 약 5초간
                      나타납니다 → 누른 뒤 <b>7055</b> 입력.
                    </li>
                    <li>
                      위 방법이 안 되면(구형 펌웨어) <b>우측 상단 모서리를 빠르게 5회 터치</b>{" "}
                      → <b>7055</b>.
                    </li>
                  </ul>
                  <div className="mt-1 text-xs text-amber-800">
                    <b>7055</b> 는 토스 공식 문서에 나오는 관리자 PIN 이 맞습니다. 다만{" "}
                    <b>설정 화면을 여는 터치 동작</b>은 토스 개발자 문서에 아예 없어서 펌웨어에
                    따라 다를 수 있습니다. 위 둘 중 되는 쪽을 알려 주시면 이 안내를 하나로
                    정리하겠습니다.
                  </div>
                </li>
              </ul>
