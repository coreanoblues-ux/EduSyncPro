            ...
            */}
            <div className="mt-2 rounded border border-amber-200 bg-white/60 p-2">
              ...
              <ul className="mt-1 list-disc space-y-0.5 pl-5">
                ...
                <li>
                  <b>토스플레이스 카드 단말기</b> — 단말기 대기화면에서{" "}
                  <b>[토스 홈으로] → [나가기]</b> 를 누르면 토스 첫화면으로 나갑니다.
                  거기서 기본 결제앱의 거래내역에서 취소하세요. 끝나면 토스 홈에서
                  이 플러그인을 다시 실행하면 됩니다.
                  <div className="text-xs text-amber-800">
                    (나가기 버튼은 플러그인 v0.3.8 부터 있습니다. 단말기 화면에 찍힌
                    버전이 그보다 낮으면 판매자센터를 쓰세요.)
                  </div>
                </li>
              </ul>
